...
# 音色迁移
from SVC.inference_main import transfer

# 播放
import pygame

# ASR
# from Chinese_speech_recognition.recording_recognition import asr
from speech_paraformer.demo_online import asr

# 传入语音
from Chinese_speech_recognition.model.models import record_speech
...
def run_chatbot(message, count):
    ...
    engine = pyttsx3.init()
    engine.save_to_file("".join(text), 'SVC/raw/speech.wav')
    engine.runAndWait()
